...
2. Leé `CLAUDE.md`, `README.md` y `.agent/skills/README.md` del template para entender qué tengo disponible (agentes, las 147 skills de proceso, frameworks, estructura).
...
### 147 skills de proceso (`.agent/skills/`)
...
| Datos, RLS y seguridad de base | 16 | `detectar-escritura-filtrada-rls`, `rls-write-bloqueada-por-policy-desalineada` |
...
| UI, UX y frontend | 24 | `auditar-responsive-midiendo`, `acciones-en-lote-seguras` |
...
| Auth y deploy | 10 | `deploy-seguro-vercel-preview-prod` |
...
├── .agent/
│   └── skills/
│       ├── README.md          ← índice temático de las 147 skills
