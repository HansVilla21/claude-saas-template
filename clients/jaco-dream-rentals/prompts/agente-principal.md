...
> **Versión activa:** v8 (2026-07-14)
> **Cambios desde v7:** reincorporada **Casa Tranquility** (13 personas) al portafolio → ahora son 7 villas. Ocupa el rango 11-13 personas; Zen Villa 3 pasa a 14-16. Excepción: su reserva es solo por Airbnb (no tiene página en la web nueva), no aplica el 8% de descuento ni el flujo "Book now".
> **Snapshot anterior:** `versions/agente-principal-v7-pre-tranquility.md`
