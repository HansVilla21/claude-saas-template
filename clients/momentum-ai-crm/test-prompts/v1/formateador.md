...
- Cambia el PUNTO Y SEGUIDO por SALTO DE LINEA. CRITICO: NUNCA borres un punto y seguido sin meter el salto de linea en su lugar — si solo quitas el punto, las dos frases quedan pegadas ("movimiento seguro Sobre el precio") con una mayuscula en medio y se ve roto
...
INPUT: "Perfecto, una muebleria tiene mucho movimiento seguro. Sobre el precio, depende de tu negocio y lo que necesites."
(el punto y seguido separa dos ideas → salto de linea OBLIGATORIO, nunca solo borrar el punto)
MAL: "Perfecto, una muebleria tiene mucho movimiento seguro Sobre el precio, depende de tu negocio y lo que necesites"
OUTPUT:
MENSAJE 1: "Perfecto, una muebleria tiene mucho movimiento seguro
Sobre el precio, depende de tu negocio y lo que necesites"
...
- Donde habia punto y seguido, quedo un SALTO DE LINEA (no dos frases pegadas con mayuscula en medio)?
