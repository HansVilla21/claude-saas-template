...
- Si el ultimo mensaje del bot propuso la LLAMADA y el lead afirma corto pero todavia no dio nombre + negocio → AGENTE_PRINCIPAL (para que capture los datos antes del handoff)
