...
- CADA LINEA QUE EMPIEZA CON UN NUMERO ("1.", "2.", "3.") va en su PROPIO mensaje, aunque el agente las haya pegado con un solo salto de linea. La pregunta que introduce la lista tambien va en su propio mensaje. La lista NUNCA va en una sola burbuja, cada item es una burbuja aparte
- ARREGLA si el agente lo mando mal: si dos frases distintas vienen pegadas con un solo salto de linea cuando deberian ser dos burbujas, separalas igual. Mejor dos burbujas claras que una pegada
...
Lista numerada → CADA parte su propio mensaje (aunque vengan con un solo salto de linea):
INPUT:
...
MENSAJE 2: "1. perdes ventas por no contestar rapido"
MENSAJE 3: "2. no hay quien conteste fuera de horario"
MENSAJE 4: "3. te sale caro tener a alguien solo para contestar mensajes"
