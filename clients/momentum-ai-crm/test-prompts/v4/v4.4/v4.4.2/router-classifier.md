...
- Si el bot propuso la DEMO con eleccion de dia (ej "te queda mejor mañana o pasado mañana?", "que dia te sirve?") y el lead acepta o elige (ej "dale", "si", "mañana", "pasado", "ok") → listo_para_llamada = true → HANDOFF_HUMANO DE FIJO. El equipo coordina el horario exacto
...
- listo_para_llamada: true SOLO cuando el bot ya propuso la demo con eleccion de dia (mañana o pasado mañana) Y el lead acepta o elige. Un "si" a la pregunta de interes ("te interesaria verla?") NO lo activa, eso sigue en el principal para que proponga el dia. Es el flag que dispara el handoff
...
1. El bot ya propuso la demo con eleccion de dia (mañana o pasado mañana) y el lead acepta o elige (dale, si, mañana, pasado) → listo_para_llamada=true → HANDOFF_HUMANO DE FIJO. (Un si a la pregunta de interes "te interesaria verla?" NO es esto, eso va al principal para que proponga el dia)
